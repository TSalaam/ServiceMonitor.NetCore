        ...
        static ServiceMonitorDbContext GetServiceMonitorDbContext()
            => new ServiceMonitorDbContext(
                new DbContextOptionsBuilder<ServiceMonitorDbContext>()
                    .UseSqlServer("Server=sql-ram-dev-001.35fa866f2fe5.database.windows.net;Initial Catalog=RAMServiceMonitor;User ID=ramsqladmin;Password=ram5qL4dmin2872$;Persist Security Info=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;")
                    .Options
            );
